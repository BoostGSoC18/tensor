...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_tensor_matrix_interoperability_ctor, value,  test_types)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_matrix_interoperability_ctor_extents, value,  test_types, fixture )
{
	using namespace boost::numeric;
	using value_type  = typename value::first_type;
	using layout_type = typename value::second_type;
